...
public enum DiscApiErrorCode implements ApiErrorCode {
  MALFORMED_XMCD(HttpServletResponse.SC_BAD_REQUEST, "Received XMCD is malformed."),
  DISC_NOT_FOUND(HttpServletResponse.SC_NOT_FOUND, "Disc not found.", "Disc with ID %s not found."),
  DUPLICATE_DISC(
      HttpServletResponse.SC_CONFLICT, "Disc already exists.", "Disc with ID %s already exists."),
  INCORRECT_DISC_ID(
      HttpServletResponse.SC_BAD_REQUEST,
      "The disc ID for this disc is incorrect.",
      "The disc ID for this disc (%08X) does not match its expected disc ID (%08X)."),
  NO_MATCH(HttpServletResponse.SC_NOT_FOUND, "No match found for the given disc.");

  @Getter private final int _status;
